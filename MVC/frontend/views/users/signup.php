            ...
            <div class="userbox">
                ...
                <form accept-charset='UTF-8' action="" id='create_customer' method='post'>
                    ...
                    <div id="first_name" class="clearfix large_form">
                        ...
                        <input required type="text" value="" name="first_name" placeholder="Họ" class="text" size="30" />
                    </div>
                    <div id="last_name" class="clearfix large_form">
                        <label for="last_name" class="label icon-field">Tên</label>
                        <input required type="text" value="" name="last_name" placeholder="Tên" class="text" size="30" />
                    </div>
