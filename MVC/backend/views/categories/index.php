...
<form action="" method="GET" >
  ...
  <div class="form-group">
    ...
    <a href="index.php?controller=category&action=index" class="btn btn-default" style="margin-left: 10px;">Xoá</a>
  </div>
</form>
    ...
    <?php foreach ($categories as $category) : ?>
      <tr>
        ...
        <td>
          ...
          <a href="index.php?controller=category&action=delete&id=<?php echo $category['id'] ?>" title="Xóa" onclick="return confirm('Bạn có chắc chắn muốn xóa bản ghi này')">
